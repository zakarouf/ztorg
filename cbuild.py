...
folderIgnore={"data", "doc" , ".git", "SDL", "demos_curses", "tools_curses", "logic", "shader", "ztorg"}
IgnoreNames={"cave_hunter.c", "ztorg-raylib.c", "zse.c"}
...
LDFLAGS=["-lm", "-lvulkan", "-lglfw", "-lncurses", "-framework","opengl", "-Wl,-rpath", "-Wl,/usr/local/lib"]
OUTEXE="build/z"
