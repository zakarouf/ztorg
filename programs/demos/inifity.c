...
static void zse_map_InScrollChunk_Vertical3x3(IN_WORLD_t *mapIN, int ChunkX, int ChunkY, int chunklineStart, int chunklineEnd, zse_i8_t incrementUP)
{
...
static void switchChunksVertical3x3(IN_WORLD_t *mapIN, int ChunkX, int ChunkY, zse_i8_t UP)
{
    int chunklineStart
    , chunklineEnd;
